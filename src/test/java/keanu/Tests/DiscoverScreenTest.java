...
public class DiscoverScreenTest extends TestBase {
	...
	public void setUp() throws Exception {
		appLibrary = new AppLibrary("Discover Screen Test");
		logger = Logger.getLogger("Discover Screen Test");
	...
	@Test(priority = 2)
	public void verifymoduleAndHeaders() throws Exception {
