...
public class MyProfileSignUpTest extends TestBase {
	...
	AppHeaders header;
	WelcomeScreen wc;
    String userName="testuser" + appLibrary.randIntDigits(99, 999);
	@BeforeClass
	public void setUp() throws Exception {
		appLibrary = new AppLibrary("MyProfile Sign-Up Test");
		logger = Logger.getLogger("MyProfile Sign-Up Test");
	...
	public void userSignUp() throws Exception {
		...
		signUp.signUp(userName, "pass123");
	}

/*	@Test(priority = 2)
	public void verifyUser() throws Exception {
		// header.navigateToMyProfile();
		// myProfile.userVerification("testuser2", "pass123");
		// header.myAccountVerification("testuser2", "neo.keanu.im");
	}
	
	@Test(priority = 3)
	public void checkDevicesAndKeys() throws Exception {
		// myProfile.navBack();
		// myProfile.deviceKeyVerify(true, false);
	}*/
}
